    ...
    return (
        <View style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
            ...
            <Button
                ...
                buttonStyle={{ backgroundColor: 'rgb(240,6,42)' }}
...
function Restaurant(props) {
    ...
    const confirmRemoveFavorite = () => {
        Alert.alert(
            ...
            "¿Estás seguro que deseas eliminar el restaurante de Favoritos?",
            [
                {
                    text: "Cancelar",
                    style: "cancel"
                ...
                response.forEach((doc) => {
                    ...
                    db.collection("favorites")
                        ...
                        .then(() => {
                            setIsLoading(false);
                            setReloadData(true);
                            toastRef.current.show("Restaurante eliminado correctamentre");
                        })
                        .catch(() => {
                            setIsLoading(false);
